...
RSpec.describe "sg_accident_histories/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit sg_accident_history form" do
    render

    assert_select "form[action=?][method=?]", sg_accident_history_path(@sg_accident_history), "post" do
