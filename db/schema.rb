...
ActiveRecord::Schema.define(version: 20161018052928) do
  ...
  create_table "onemap_tokens", force: :cascade do |t|
    t.string   "token"
    t.datetime "expiry_timestamp"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
  end
  ...
  create_table "sg_bus_stops", force: :cascade do |t|
    t.integer  "bus_id"
    t.string   "road_name"
