Rails.application.routes.draw do
  ...
  namespace :api do
    ...
    match "users/update_noti_setting"               => "users#update_noti_setting"              , via: [:get, :post]
    match "users/get_trip_list"                     => "users#get_trip_list"                    , via: [:get, :post]
    ...
    match "roundtrip/save_user_fav_bus"           => "roundtrip#save_user_fav_bus"    , via: [:get, :post]
    match "roundtrip/delete_user_fav_bus"           => "roundtrip#delete_user_fav_bus"    , via: [:get, :post]
    ...
    match "roundtrip/get_sg_services"               => "roundtrip#get_sg_services"    , via: [:get, :post]
    match "roundtrip/get_bus_directions"               => "roundtrip#get_bus_directions"    , via: [:get, :post]
